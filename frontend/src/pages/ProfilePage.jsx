...
import supabase from "../client"; // updated import per Chris
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-start gap-10">
          ...
          <div className="flex-1">
            ...
            <p className="mt-2 max-w-xl leading-relaxed">{userInfo.about}</p>
        ...
        <div className="mt-16">
          ...
          {reviews.length === 0 ? (
            <p className="mt-4 text-gray-300">Reviews feature coming soon…</p>
          ) : (
            reviews.map((r) => (
              <p key={r.id} className="mt-2 text-gray-200">
                {r.title}
              </p>
            ))
          )}
